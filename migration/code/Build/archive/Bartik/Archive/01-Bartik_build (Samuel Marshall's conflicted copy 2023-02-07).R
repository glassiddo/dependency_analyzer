...
# mig_od <- od_flow(sa_2011, 2001, 2010, ctry3 = ccode)
#pop_df <- f_pop(sa_2011, sa_2016, ctry3 = ccode)
#loss_df <- geo_forestloss(ann_treeloss, district_name, 2012, 2015) 
...
mult_df <- bind_rows(
  ...
  mutate(
    year1 = case_when(
      ...
      Country == "SEN" ~ 2002,
      Country == "SLE" ~ 2004,
      Country == "SAF" & adm %in% c(1,2) ~ 2011,
      Country == "SAF" & adm == 3 ~ 2001,
      Country == "TZA" ~ 2002,
      Country == "UGA" ~ 2002,
      Country == "ZMB" ~ 2000,
    ),
