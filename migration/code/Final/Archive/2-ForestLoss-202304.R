...
#*******************************************************************************
# Benin 2 ----
ctry_df <- f_forestloss("Benin", 2, 2003, 2012)
loss_df <- ctry_df

# Botswana 1 ----
ctry_df <- f_forestloss("Botswana", 1, 2002, 2010) 
loss_df <- bind_rows(loss_df, ctry_df)

# Burkina Faso ----
ctry_df <- f_forestloss("Burkina Faso", 2, 2001, 2005) 
loss_df <- bind_rows(loss_df, ctry_df)

# Cameroon ----
ctry_df <- f_forestloss("Cameroon", 2, 2001, 2005)   
loss_df <- bind_rows(loss_df, ctry_df)

# Ghana ----
ctry_df <- f_forestloss("Ghana", 2, 2001, 2009) 
loss_df <- bind_rows(loss_df, ctry_df)

# Guinea ----
ctry_df <- f_forestloss("Guinea", 1, 2001, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)

# Kenya ----
ctry_df <- f_forestloss("Kenya", 2, 2001, 2008) 
loss_df <- bind_rows(loss_df, ctry_df)

# Lesotho ----
ctry_df <- f_forestloss("Lesotho", 1, 2001, 2005) 
loss_df <- bind_rows(loss_df, ctry_df)

# Malawi ----
ctry_df <- f_forestloss("Malawi", 1, 2009, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)

# Mali ----
ctry_df <- f_forestloss("Mali", 2, 2001, 2008) 
loss_df <- bind_rows(loss_df, ctry_df)

# Mauritius ----
ctry_df <- f_forestloss("Mauritius", 1, 2001, 2010) 
loss_df <- bind_rows(loss_df, ctry_df)

# Mozambique ----
ctry_df <- f_forestloss("Mozambique", 2, 2001, 2006) 
loss_df <- bind_rows(loss_df, ctry_df)

# Rwanda ----
ctry_df <- f_forestloss("Rwanda", 2, 2012, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)

# Senegal ----
ctry_df <- f_forestloss("Senegal", 2, 2003, 2012) 
loss_df <- bind_rows(loss_df, ctry_df)

# Sierra Leone ----
ctry_df <- f_forestloss("Sierra Leone", 2, 2005, 2014) 
loss_df <- bind_rows(loss_df, ctry_df)

# South Africa ----
ctry_df <- f_forestloss("South Africa", 2, 2002, 2010) 
loss_df <- bind_rows(loss_df, ctry_df)

# Sudan & S. Sudan ----
ctry_df <- f_forestloss("Sudan", 1, 2009, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)

# Tanzania ----
ctry_df <- f_forestloss("Tanzania", 1, 2003, 2011) 
loss_df <- bind_rows(loss_df, ctry_df)

# Togo ----
ctry_df <- f_forestloss("Togo", 2, 2010, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)

# Uganda ----
ctry_df <- f_forestloss("Uganda", 1, 2003, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)

# Zambia ----
ctry_df <- f_forestloss("Zambia", 2, 2001, 2009) 
loss_df <- bind_rows(loss_df, ctry_df)

# Zimbabwe ----
ctry_df <- f_forestloss("Zimbabwe", 2, 2012, 2013) 
loss_df <- bind_rows(loss_df, ctry_df)
